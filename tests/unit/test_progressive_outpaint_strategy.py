...
class TestProgressiveOutpaintStrategy:
    ...
    def test_execute_no_aspect_change(self):
        ...
        with patch.object(
            self.strategy.dimension_calc, "calculate_progressive_strategy"
        ) as mock_calc:
    ...
    def test_execute_aspect_change(self):
        ...
        with patch.object(
            ...
            with patch.object(
                self.strategy, "_execute_outpaint_step", side_effect=mock_outpaint
            ):
    ...
    def test_execute_with_context(self):
        ...
        context = {"save_stages": True, "boundary_tracker": Mock()}
