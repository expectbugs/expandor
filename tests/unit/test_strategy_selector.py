...
from expandor.core.strategy_selector import SelectionMetrics, StrategySelector
...
class TestStrategySelector:
    ...
    def setup_method(self):
        ...
        self.config = {
            ...
            "quality_presets": {"ultra": {}, "balanced": {}},
            "vram_strategies": {
        ...
        self.selector = StrategySelector(
            config=self.config, vram_manager=self.vram_manager
        )
    ...
    def test_calculate_metrics(self):
        ...
        assert metrics.has_refiner == False  # Refiner is optional in new API
    ...
    def test_select_by_vram_constraint(self):
        ...
        assert strategy_name in ["tiled", "cpu_offload"]
    ...
    def test_strategy_override(self):
        ...
        config = ExpandorConfig(
            ...
            seed=42,
            source_metadata={"model": "test"},
            strategy_override="tiled",
        )

        strategy_name, reason, metrics = self.selector.select_strategy(config)

        assert strategy_name == "tiled_expansion"
        assert reason == "User specified"
    ...
    def test_extreme_ratio_swpo(self):
        ...
        self.config["strategies"]["progressive_outpainting"][
