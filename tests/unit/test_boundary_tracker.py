...
from expandor.core.boundary_tracker import BoundaryInfo, BoundaryTracker
...
class TestBoundaryTracker:
    ...
    def test_add_progressive_boundary(self):
        ...
        self.tracker.add_progressive_boundary(
            position=256, direction="vertical", step=2, expansion_size=128
        )
    ...
    def test_add_progressive_boundaries(self):
        ...
        self.tracker.add_progressive_boundaries(
            current_size=(512, 512), target_size=(1024, 512), step=1
        )
        ...
        # Vertical expansion
        self.tracker.add_progressive_boundaries(
            current_size=(512, 512), target_size=(512, 768), step=1
        )
    ...
    def test_get_boundary_regions(self):
        ...
        regions = self.tracker.get_boundary_regions(width=1000, height=800, padding=10)
    ...
    def test_summarize(self):
        ...
        self.tracker.add_boundary(
            100, "horizontal", 1, 200, (0, 0), (0, 0), "progressive"
        )
        self.tracker.add_boundary(
            200, "vertical", 1, 150, (0, 0), (0, 0), "progressive"
        )
